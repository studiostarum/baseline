...
<template>
    <div class="relative hidden w-full md:block">
        ...
        <div
            ...
            <div class="flex h-8 items-center gap-2 border-b border-border/30 bg-muted/30 px-4">
                <div class="mr-2 flex items-center gap-2">
                    <button
                        ...
                        :key="i"
                        type="button"
                        class="group flex aspect-square cursor-pointer items-center justify-center rounded-full p-px transition"
                        :class="control.bg">
                        <component
                            :is="control.icon"
                            class="size-3 text-black/80 opacity-0 transition-opacity group-hover:opacity-100" />
                    </button>
                </div>
                <div
                    class="flex items-center gap-1.5 rounded-t border border-b-0 border-border/50 bg-background/80 px-3 py-1">
                    <AppLogoIcon class="size-3.5 text-primary" />
            ...
            <!-- Browser Chrome -->
            <div class="flex h-12 items-center justify-between gap-4 border bg-secondary pl-2 pr-4">
