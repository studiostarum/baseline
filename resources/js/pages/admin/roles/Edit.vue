                    ...
                    <CardContent class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                required
                            />
                            <p v-if="isSuperAdmin" class="text-sm text-muted-foreground">
                    ...
                    <CardHeader>
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>
                                    {{ isSuperAdmin ? 'Super admin has all permissions by default.' : 'Manage role permissions.' }}
                                </CardDescription>
                            </div>
                        ...
                        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            >
                                ...
                                <Label
                                    ...
                                    :class="{ 'cursor-pointer': !isSuperAdmin, 'opacity-50': isSuperAdmin }"
                                >
                                    {{ permission.name }}
                                </Label>
                            </div>
