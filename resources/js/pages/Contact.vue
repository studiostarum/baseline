...
<template>
    <WebsiteLayout :title="t('website.contact.page_title')">
        <section
                id="contact"
                class="w-full px-[5%] py-16 text-left md:py-24 lg:py-28"
            >
                    ...
                    >
                        <div>
                            ...
                            <div class="mb-6 md:mb-8">
                                <h2
                                    class="mb-5 font-bold text-4xl tracking-tight md:mb-6 md:text-5xl lg:text-6xl"
                                >
                        ...
                        >
                            ...
                            <div class="grid w-full items-center gap-2">
                                ...
                                <Textarea
                                    id="message"
                                    name="message"
                                    :placeholder="t('website.contact.message_placeholder')"
